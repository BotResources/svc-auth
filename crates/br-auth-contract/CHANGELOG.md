...
- Bumped the `br-core-auth` / `br-core-kernel` pins from `br-rust-common` v1.2.0
  to **v1.3.0**. Minor bump because the public `BearerEntry.actor` field is a
  `br_core_kernel::Actor`, so a consumer of this crate now agrees on the v1.3.0
